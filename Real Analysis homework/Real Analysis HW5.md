...
**(b)** $\frac{5}{16} = 0.0101_2$ (finite binary) = $0.01001111\ldots_2$. The corresponding ternary expansions in $C$ are $0.0202_3 = \frac{20}{81}$ and $0.02000222\ldots_3 = \frac{19}{81}$. Since $\frac{5}{16}$ is dyadic, $\Lambda$ is constant on the interval between these two points. Thus $\Lambda^{-1}(\{5/16\}) = [\frac{19}{81}, \frac{20}{81}]$.
___
