...
3.  **Check unbiasedness:**
    Since $X_i \sim N(0, \sigma^2)$, we have $\frac{X_i}{\sigma} \sim N(0,1)$ and thus $X_i^2 / \sigma^2 \sim \chi^2_{(1)}$.
...
1.  **Likelihood Function:**
    The joint density is $f(x_1,...,x_n; \sigma^2) = \prod_{i=1}^n \frac{1}{\sqrt{2\pi\sigma^2}} e^{-\frac{x_i^2}{2\sigma^2}}$.
...
**Note:**
In this specific problem where the mean is known to be zero, both the MoM and MLE estimators for $\sigma^2$ are identical: $\frac{1}{n} \sum_{i=1}^n X_i^2$.