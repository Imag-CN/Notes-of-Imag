...
Therefore every right ideal of $\operatorname{Hom}(V,V)$ is of the form $\operatorname{Hom}(V,W)$ for a subspace $W\subseteq V$. Since $\operatorname{Hom}(V,W_1)\subsetneq\operatorname{Hom}(V,W_2)$ iff $W_1\subsetneq W_2$, the maximal right ideals correspond exactly to those $W$ with $\operatorname{codim} W=1$, i.e. $I=\operatorname{Hom}(V,W)$ with $\dim V/W=1$.